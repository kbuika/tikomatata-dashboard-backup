  ...
  const fetchAllTransactions = async (eventId: string | undefined, currentTablePage: number | string) => {
    ...
    try {
      ...
      if (res.status === 200) {
        ...
        filteredData = filteredData.filter((entry:any) => !["denno@tikomatata.com", "jamesnyale@gmail.com", "shedrackfondo@gmail.com", "juliusgunga99@gmail.com", "luniceobade@yahoo.com"].includes(entry.recipientEmail));
